...
from ..bitrix24_client.exceptions import (
    Bitrix24APIError, RateLimitError, AuthenticationError, 
    ServerError, NetworkError, BadRequestError, NotFoundError, TimeoutError
)
...
class ErrorHandler:
    ...
    def __init__(self, log_errors: bool = True, save_error_reports: bool = True):
        ...
        self.error_mapping = {
            ...
            AuthenticationError: (ErrorCategories.API_AUTHENTICATION, ErrorSeverity.CRITICAL),
    ...
    def handle_error(self, 
                    ...
                    reraise: bool = False) -> ErrorContext:
        """
...
class ErrorReporter:
    ...
    def generate_summary_report(self) -> str:
        ...
        if summary["severity_levels"]:
            ...
            severity_order = [ErrorSeverity.CRITICAL, ErrorSeverity.HIGH, 
    ...
    def generate_detailed_report(self, last_n_errors: int = 5) -> str:
        ...
        for i, error_ctx in enumerate(recent_errors, 1):
            category, severity = self.error_handler._classify_error(error_ctx.error_type)
