...
class ExcelDataFormatter:
    ...
    def _format_single_invoice(
        self, invoice: Dict[str, Any], row_number: int
    ) -> Dict[str, Any]:
        """
    ...
    def _format_amounts(self, amount: Any, vat_rate: str) -> Dict[str, Any]:
        ...
        try:
            ...
            without_vat_display = self.currency_processor.format_currency_russian(
                without_vat
            )
...
class ExcelSummaryFormatter:
    ...
    def format_summary(self, formatted_data: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            ...
            "total_without_vat": self.currency_processor.format_currency_russian(
                total_without_vat
            ),
            "total_with_vat": self.currency_processor.format_currency_russian(
                total_with_vat
            ),
